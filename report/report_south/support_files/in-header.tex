...
% Font setup (LuaLaTeX/XeLaTeX via Quarto)
\usepackage{fontspec}
\defaultfontfeatures{Ligatures=TeX}

% Explicit face mapping for Latin Modern Sans
\setsansfont{Latin Modern Sans}[]

% Make entire document sans-serif
...
\lohead{Lingcod (South) assessment 2027}
