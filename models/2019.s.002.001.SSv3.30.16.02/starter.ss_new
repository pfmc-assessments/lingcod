...
#C file write time: 2017-06-29 19:48:49
Ling.dat
Ling.ctl
...
1887 # min yr for sdreport outputs (-1 for styr); #_1887
2032 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2032
...
2 # F_std_basis: 0=raw_annual_F; 1=F/Fspr; 2=F/Fmsy; 3=F/Fbtgt; where F means annual_F; values >=11 invoke multiyr with 10's digit
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1621601876
