...
#C file write time: 2021-05-24 17:07:52
ling_data.ss
ling_control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1887
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2021
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1622047729
