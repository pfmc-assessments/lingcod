...
with faster growth in the north for both females and males relative to
the south (Figure \@ref(fig:compare-north-vs-south-growth)).
...
Estimates of unfished spawning biomass in the two areas are similar 
...
densities been equal in the two areas. However, the estimated
catchability of the \gls{s-wcgbt} is similar among areas: 
<!-- values not dynamic --> 
0.88 in the north and 0.73 in the south, although, differences in estimated selectivity
of this survey between areas make interpretation of catchability more complex.

<!-- values not dynamic in text below
plot_twopanel_comparison(list(mod.2021.n.022.103, mod.2021.s.014.103))
mod.2021.n.022.103$cpue$Calc_Q[mod.2021.n.022.103$cpue$Fleet == 7][1]
#[1] 2.00112
mod.2021.s.014.103$cpue$Calc_Q[mod.2021.s.014.103$cpue$Fleet == 7][1]
[1] 0.340221
-->
...
for almost all years from the 1940s onward in spite of the much smaller area 
covered. The catchability of the \gls{s-wcgbt} in those scenarios is likewise
implausibly different: 2.00 in the north and 0.34 in the south
