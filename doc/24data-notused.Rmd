...
See the following pdfs for more information about these indices that were not included in this assessment:
lingcod_CRFS_PR_dockside_writeup.NCA.pdf and lingcod_CRFS_PR_dockside_writeup.SCA.pdf.