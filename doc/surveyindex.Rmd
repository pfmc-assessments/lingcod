...
Furthermore, there was no clear pattern in residuals (Figure \@ref(fig:s-wcgbts-scaledresidualsmap)).
This model was specific to the area included in this assessment because
separate models were fit for each area rather than
using the stratification functionality to partition the results from a single
model to each area. This was done to ensure that the correlation structure
