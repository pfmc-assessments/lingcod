...
(Figures \@ref(fig:fig:s-wcgbt-VAST-inputgrid) and \@ref(fig:fig:s-wcgbt-VAST-mesh))
...
(Figures \@ref(fig:fig:s-tri-VAST-inputgrid) and \@ref(fig:fig:s-tri-VAST-mesh)).
...
Although, there was no clear spatial pattern in the residuals (Figure \@ref(fig:s-tri-VAST-scaledresidualsmap)).
