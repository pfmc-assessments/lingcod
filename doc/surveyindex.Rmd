...
from 30 - 700 fathoms (55 - 1,280 meters) on an annual basis
(excluding 2020 due to COVID-19).
...
Spatial variation was approximated using 500 knots,
and the model used the bias-correction algorithm
[@thorson_implementing_2016] in Template Model Builder [@kristensen_tmb:_2016].

The estimated index of abundance was assumed to follow a lognormal distribution
(Figure \@ref(fig:))
...
and survey methodology are described by Harms et al. [-@harms_noaa_2008].
