...
```
(Figure \ref{fig:len-weight}). These relationships are very similar to those used for the previous assessment (@haltuch_2017_2018).
...
@jagielo_lingcod_1994 estimated growth using a fixed length at age 1 of 30 cm
