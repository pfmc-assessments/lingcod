...
`r sprintf("$W=%1.004e * L^{%1.004e}$", ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_F[1], lw.WCGBTS$South_NWFSC.Combo_F[1]), ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_F[2], lw.WCGBTS$South_NWFSC.Combo_F[2]))` for females and
`r sprintf("$W=%1.004e * L^{%1.004e}$", ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_M[1], lw.WCGBTS$South_NWFSC.Combo_M[1]), ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_M[2], lw.WCGBTS$South_NWFSC.Combo_M[2]))` for males
...
$W = 1.760e^{-06} * L^{3.3978}$ for females and
$W = 3.953e^{-06} * L^{3.2149}$ for males.
...
These estimates are from `r ifelse(params$area == "North", "5,145", "3,910")` age and length samples, of which
`r ifelse(params$area == "North", "3,290", "")` are female and
