...
`r sprintf("$W=%1.009e * L^{%1.004e}$", ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_F[1], lw.WCGBTS$South_NWFSC.Combo_F[1]), ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_F[2], lw.WCGBTS$South_NWFSC.Combo_F[2]))` for females, and
`r sprintf("$W=%1.009e * L^{%1.004e}$", ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_M[1], lw.WCGBTS$South_NWFSC.Combo_M[1]), ifelse(params$area == "North", lw.WCGBTS$North_NWFSC.Combo_M[2], lw.WCGBTS$South_NWFSC.Combo_M[2]))` for males
