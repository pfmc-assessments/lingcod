...
```{asis, opts.label = 'north'}
$W=$`r format(lw.WCGBTS$North_NWFSC.Combo_F[1], scientific = TRUE)`$L^`r format(lw.WCGBTS$North_NWFSC.Combo_F[2], scientific = TRUE)` for females, and 
$W=$`r format(lw.WCGBTS$North_NWFSC.Combo_M[1], scientific = TRUE)`$L^`r format(lw.WCGBTS$North_NWFSC.Combo_M[2], scientific = TRUE)` for males 
```
```{asis, opts.label = 'south'}
$W=$`r format(lw.WCGBTS$South_NWFSC.Combo_F[1], scientific = TRUE)`$L^`r format(lw.WCGBTS$South_NWFSC.Combo_F[2], scientific = TRUE)` for females, and 
$W=$`r format(lw.WCGBTS$South_NWFSC.Combo_M[1], scientific = TRUE)`$L^`r format(lw.WCGBTS$South_NWFSC.Combo_M[2], scientific = TRUE)` for males 
```
...
[**to do: Confirm equations show up now**]
```{asis, opts.label = 'north'}
$k$ = `r round(la.WCGBTS$North_NWFSC.Combo_F[2],3)` and  $L_{\infty}$ = `r round(la.WCGBTS$North_NWFSC.Combo_F[1],3)` for females, and $k$= `r  round(la.WCGBTS$North_NWFSC.Combo_M[2],3)` and  $L_{\infty}$ = `r round(la.WCGBTS$North_NWFSC.Combo_M[1],3)` for males. 
These estimates are from 5,145 age and length samples, of which 3,290 are female, and 1,795 are male.
```
```{asis, opts.label = 'south'}
$k$ = `r round(la.WCGBTS$South_NWFSC.Combo_F[2],3)` and  $L_{\infty}$ = `r round(la.WCGBTS$South_NWFSC.Combo_F[1],3)` for females, and $k$= `r  round(la.WCGBTS$South_NWFSC.Combo_M[2],3)` and  $L_{\infty}$ = `r round(la.WCGBTS$South_NWFSC.Combo_M[1],3)` for males. 
