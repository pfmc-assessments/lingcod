...
ignore <- ggsave2(
  ...
  alttext = paste0(
    tolower(reccpuewa_SMcoefs[1, "names"]), " and ",
...
utils::write.csv(
  ...
  data.frame(
    ...
    filein = file.path("..", "figures", "reccpuewa-ScaledQQplot_pos.png")
  ),
  file = file.path("..", "figures", "reccpuewa-ScaledQQplot_pos.csv")
)
#
#
#
...
`r scales::percent(1-dim(tot %>% dplyr::filter({{colresponse}}>0))[1]/dim(tot)[1])`
