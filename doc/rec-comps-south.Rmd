...
fishery were also obtained from the CDFW. These include `r spp` samples from onboard 
...
California that focused on `r spp` and Blue rockfish (*Sebastes mystinus*) sampling, 
...
data sources (Figure \ref{fig:comp-lendat--page2-multi-fleet-comparison}). 
