...
Jagielo [-@jagielo1994assessment] conducted an age-structured assessment of its status
...
matched the spatial structure used for 2009 [@hamel2009] but made numerous changes,
including
...
was $\sigma$ = `r round(model$Pstar_sigma,2)` and the uncertainty around 
the OFL was $\sigma$ = `r round(model$OFL_sigma, 2)`. This is an 
...
<!-- doc is currently empty, but Ian is getting started on it now (7pm Saturday) -->
```{r render-model-selection, results = "asis"}
