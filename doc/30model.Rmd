...
- addition of numerous fishery-dependent CPUE indices and the \gls{s-hkl} index
...
- different treatment of some age data as marginal vs conditioned on length
...
sa4ss::read_child("model-specification.Rmd")
```
