...
(Figure \ref{fig:comp-lendat--page1-multi-fleet-comparison})
...
(Figures \ref{fig:discard-fitcommercial-trawl.png}-\ref{fig:bodywt-fit-fltcommercial-fixed-gear.png})
