...
sa4ss::read_child(filein = file.path(paste0("length_samps_comm_byState_", params$area, ".tex")))

sa4ss::read_child(filein = file.path(paste0("age_samps_comm_byState_", params$area, ".tex")))
```
