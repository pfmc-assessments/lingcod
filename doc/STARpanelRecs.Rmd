...
on ageing error among readers (see Section \@ref(ageing-precision-and-bias).
...
Additional explorations made during the STAR panel review for the southern model led to
changing the timing of the main recruitment period because of the removal of early length data
that led to less information to estimate these early recruitment deviations.
