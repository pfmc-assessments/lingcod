...
and therefore equal assignment is not influenced by sex-specific size differences. Figure \ref{fig:wcgbts-lenComp} shows the length frequency distributions for the \Gls{s-wcgbt}. 
...
fork length following conversions from Laidig et al. @Laidig_conversion. Total
