...
A block on selectivity associated with 1995, the year associated with expanded 
spatial coverage and shift in timing, was considered but not included in the 
base model.
