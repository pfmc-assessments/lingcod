...
- In the *south* model, the recreational CPFV DebWV index and associated 
length composition were separated into a new fleet to allow different
assumptions about selectivity
- In the *north* model, a California recreational fishery for the catches
...
- Fix $\sigma_R$ = 0.6 for both models (in 2017 had been iteratively 
