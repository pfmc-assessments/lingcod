...
![Landings (mt) by fleet used in the base model.\label{fig:es-catch}](`r paste0('"', filein = file.path("..", mod_loc, "plots", "catch2 landings stacked.png"), '"')`){width=100% height=100% alt="."}
...
Recent estimates of fishing intensity indicate stability within the fishery and are close to pre-1950 estimates.
```
```{asis, opts.label = "south"}
The stock was estimated to have been harvested above the target proxy harvest rate from the 1970s to approximately the late 1990s and again in the early 2000s
