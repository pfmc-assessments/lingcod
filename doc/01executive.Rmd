...
Stocks were split at \CapeM based on genetic information.
...
assume that these flanking populations do not contribute to the stocks being assessed here.
```
...
length data were modeled as sex-specific compositions for fish that were sexed and as combined sex for fish that were measured but not sexed.
