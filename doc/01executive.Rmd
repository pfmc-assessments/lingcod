...
(Table \@ref(tab:referenceES); Figures \@ref(fig:es-phase) and \@ref(fig:es-yield)).
The uncertainty in this estimate spans well below all estimated reference point and nearly reaches 1.0, which would indicate the stock is at unfished levels
