...
(Table \@ref(tab:OR_ORBS_CPUE_model_selection)). Season and mega-region were also
...
final index (Figure \@ref(fig:index-data-all-fleets)). As an
...
found in (Figure \@ref(fig:fig-Dnbin-marginal-ORAtSea)). The final index
(Table \@ref(tab:tab-index-ORAtSea)) represents a similar trend to the
arithmetic mean of the annual CPUE (Figure \@ref(fig:fig-cpue-ORAtSea)).
