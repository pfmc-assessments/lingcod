...
-->
The conditional age-at-length data (CAAL, "A\@LComp" in the electronic appendix)
in the north model are numerous. They represent over 72,000 individual fish
...
```
```{asis, echo = TRUE, eval = ifelse(params$area == "Sout", TRUE, FALSE)}
...
and represented as conditional age-at-length data (CAAL, "A\@LComp" in 
electronic appendix). These represent about 3,400 fish (compared to over
