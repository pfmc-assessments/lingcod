...
`r ref_range(figurecsv, grep = "cond.+resid", fleets = get_fleet("WCGBTS", col = "num"), encapsulate = FALSE)`; "A\@LComp" in the electronic appendix shows additional fleets). 
...
(`r ref_range(figurecsv, grep = "dis.+fit", column = "file", fleets = "comm", encapsulate = FALSE)`; "Discard" in electronic appendix) 
...
(`r ref_range(figurecsv, grep = "bodywt.+fit", column = "file", fleets = "comm", encapsulate = FALSE)`; "Mnwt" in electronic appendix).
